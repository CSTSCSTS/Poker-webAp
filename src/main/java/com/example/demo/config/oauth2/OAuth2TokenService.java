...
public class OAuth2TokenService {
    ...
    public OAuth2TokenService(OAuth2AuthorizedClientService authorizedClientService,
        ...
        this.provider = properties.getProvider().get("keycloak");
        this.registration = properties.getRegistration().get("keycloak");
    }
    ...
    private void refresh() {
      ...
      formParams.add("refresh_token", getRefreshValue());
